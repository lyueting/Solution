package com.example.solution.constant;
...
public class Constant {
    ...
    public final static String ANIMAL_SING = "I am singing";
    public final static String CHICKEN_SING = "Cluck, cluck";
    public final static String DUCK_SING = "Quack , quack";
